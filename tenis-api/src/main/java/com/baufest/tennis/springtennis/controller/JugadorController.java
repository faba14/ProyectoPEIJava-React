...
public class JugadorController {
    ...
    @GetMapping("/actions/getGanancias")
    public ResponseEntity<List<Long>> calcularGanancias(){
        List<Long> ganancias = jugadorService.calcularGanancias();
        return new ResponseEntity<>(ganancias,HttpStatus.OK);
    }
