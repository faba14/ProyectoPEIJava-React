...
class PartidoServiceTest {
    ...
    Jugador jugador1 = new Jugador( "Federer", SCORE_30 , new Entrenador("bruno") );
    Jugador jugador2 = new Jugador( "Nadal", SCORE_30 , new Entrenador("bruno"));

    JugadorDTO jugadorDTO1 = new JugadorDTO( "Federer", SCORE_30, new EntrenadorDTO("bruno"));
    JugadorDTO jugadorDTO2 = new JugadorDTO( "Nadal", SCORE_30 , new EntrenadorDTO("bruno"));
